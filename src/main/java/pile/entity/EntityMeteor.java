...
import pile.procedure.ProcedureMeteorOnInitialEntitySpawn;
import pile.procedure.ProcedureMeteorOnEntityTickUpdate;
...
public class EntityMeteor extends ElementsThePile.ModElement {
	public static final int ENTITYID = 40;
	public static final int ENTITYID_RANGED = 41;
	public EntityMeteor(ElementsThePile instance) {
		super(instance, 330);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("pile", "meteor"), ENTITYID)
				.name("meteor").tracker(0, 3, true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelFallenMeteor(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("pile:textures/fallenmeteort.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityCreature {
		...
		public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
			...
			Entity entity = this;
			{
				...
				ProcedureMeteorOnInitialEntitySpawn.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onEntityUpdate() {
			...
			Entity entity = this;
			{
				...
				ProcedureMeteorOnEntityTickUpdate.executeProcedure($_dependencies);
			}
		}
