...
public class EntityMolbo extends ElementsThePile.ModElement {
	public static final int ENTITYID = 19;
	public static final int ENTITYID_RANGED = 20;
	public EntityMolbo(ElementsThePile instance) {
		super(instance, 222);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("pile", "molbo"), ENTITYID)
				.name("molbo").tracker(64, 3, true).egg(-13057, -1).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 5, 1, 2, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("pile:textures/molbo.png");
				}
			};
