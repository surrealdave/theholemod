 ...
 *
 *    Keep the ElementsThePile object in this class and all calls to this object
...
public class ThePile {
	...
	@Mod.Instance(MODID)
	public static ThePile instance;
	public ElementsThePile elements = new ElementsThePile();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsThePile.GuiHandler());
