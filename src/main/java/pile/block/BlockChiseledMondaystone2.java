...
public class BlockChiseledMondaystone2 extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:chiseledmondaystone2")
	public static final Block block = null;
	public BlockChiseledMondaystone2(ElementsThePile instance) {
		super(instance, 120);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("chiseledmondaystone2"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("pile:chiseledmondaystone2", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("chiseledmondaystone2");
