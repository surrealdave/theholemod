...
import pile.procedure.ProcedureCorn3UpdateTick;
...
public class BlockCorn3 extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:corn3")
	public static final Block block = null;
	public BlockCorn3(ElementsThePile instance) {
		super(instance, 202);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:corn3", "inventory"));
	}
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("corn3");
			setRegistryName("corn3");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCornKernel.block, (int) (1)));
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCorn3UpdateTick.executeProcedure($_dependencies);
			}
