...
public class BlockIsopile extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:isopile")
	public static final Block block = null;
	public BlockIsopile(ElementsThePile instance) {
		super(instance, 27);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:isopile", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("isopile");
			setRegistryName("isopile");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemIsopodItem.block, (int) (4)));
		}
