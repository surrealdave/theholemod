...
public class BlockGrapevine extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:grapevine")
	public static final Block block = null;
	public BlockGrapevine(ElementsThePile instance) {
		super(instance, 78);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:grapevine", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockGrapevine.block, (int) (1)));
		}
