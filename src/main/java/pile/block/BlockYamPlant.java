...
public class BlockYamPlant extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:yamplant")
	public static final Block block = null;
	public BlockYamPlant(ElementsThePile instance) {
		super(instance, 13);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:yamplant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("yamplant");
			setRegistryName("yamplant");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemYam.block, (int) (1)));
		}
