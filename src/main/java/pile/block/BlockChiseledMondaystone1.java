...
public class BlockChiseledMondaystone1 extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:chiseledmondaystone1")
	public static final Block block = null;
	public BlockChiseledMondaystone1(ElementsThePile instance) {
		super(instance, 119);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("chiseledmondaystone1"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("pile:chiseledmondaystone1", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("chiseledmondaystone1");
