...
import pile.procedure.ProcedurePorciniMushroomPlantDestroyedByPlayer;
...
public class BlockPorciniMushroom extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:porcinimushroom")
	public static final Block block = null;
	public BlockPorciniMushroom(ElementsThePile instance) {
		super(instance, 75);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:porcinimushroom", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0.1F);
			setUnlocalizedName("porcinimushroom");
			setRegistryName("porcinimushroom");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(BlockPorciniMushroom.block, (int) (1)));
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedurePorciniMushroomPlantDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
