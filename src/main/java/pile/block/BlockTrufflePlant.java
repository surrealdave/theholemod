...
public class BlockTrufflePlant extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:truffleplant")
	public static final Block block = null;
	public BlockTrufflePlant(ElementsThePile instance) {
		super(instance, 255);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:truffleplant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0.05F);
			setUnlocalizedName("truffleplant");
			setRegistryName("truffleplant");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemTruffle.block, (int) (1)));
		}
