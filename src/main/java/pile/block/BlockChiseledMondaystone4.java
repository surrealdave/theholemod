...
public class BlockChiseledMondaystone4 extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:chiseledmondaystone4")
	public static final Block block = null;
	public BlockChiseledMondaystone4(ElementsThePile instance) {
		super(instance, 122);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("chiseledmondaystone4"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("pile:chiseledmondaystone4", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("chiseledmondaystone4");
