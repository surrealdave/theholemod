...
import pile.procedure.ProcedureCornUpdateTick;
...
public class BlockCorn extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:corn")
	public static final Block block = null;
	public BlockCorn(ElementsThePile instance) {
		super(instance, 172);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:corn", "inventory"));
	}
	public static class BlockCustomFlower extends BlockReed {
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCornUpdateTick.executeProcedure($_dependencies);
			}
