...
public class BlockChiseledGarlicrockSlab extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:chiseledgarlicrockslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("pile:chiseledgarlicrockslab_double")
	public static final Block block_slab_double = null;
	public BlockChiseledGarlicrockSlab(ElementsThePile instance) {
		super(instance, 18);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("chiseledgarlicrockslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("chiseledgarlicrockslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("pile:chiseledgarlicrockslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("chiseledgarlicrockslab");
