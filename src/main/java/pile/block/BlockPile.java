...
import pile.procedure.ProcedurePileMobplayerColidesBlock;
...
public class BlockPile extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:pile")
	public static final Block block = null;
	public BlockPile(ElementsThePile instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:pile", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("pile");
			setRegistryName("pile");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCrabItem.block, (int) (2)));
		}
		...
		public void onEntityCollidedWithBlock(World world, BlockPos pos, IBlockState state, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				ProcedurePileMobplayerColidesBlock.executeProcedure($_dependencies);
			}
		}
	}
}
