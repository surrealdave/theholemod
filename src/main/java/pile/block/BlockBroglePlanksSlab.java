...
public class BlockBroglePlanksSlab extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:brogleplanksslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("pile:brogleplanksslab_double")
	public static final Block block_slab_double = null;
	public BlockBroglePlanksSlab(ElementsThePile instance) {
		super(instance, 32);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("brogleplanksslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("brogleplanksslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:brogleplanksslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("brogleplanksslab");
