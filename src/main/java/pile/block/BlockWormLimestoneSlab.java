...
public class BlockWormLimestoneSlab extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:wormlimestoneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("pile:wormlimestoneslab_double")
	public static final Block block_slab_double = null;
	public BlockWormLimestoneSlab(ElementsThePile instance) {
		super(instance, 410);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("wormlimestoneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("wormlimestoneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:wormlimestoneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("wormlimestoneslab");
