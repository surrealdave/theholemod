...
import pile.procedure.ProcedureCorn2BlockDestroyedByPlayer;
...
public class BlockCorn2 extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:corn2")
	public static final Block block = null;
	public BlockCorn2(ElementsThePile instance) {
		super(instance, 176);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:corn2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("corn2");
			setRegistryName("corn2");
		}

		@Override
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCornOnTheCob.block, (int) (0)));
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCorn2BlockDestroyedByPlayer.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
