...
import pile.procedure.ProcedureCornCubeBlockIsPlacedBy;
...
public class BlockCornCube extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:corncube")
	public static final Block block = null;
	public BlockCornCube(ElementsThePile instance) {
		super(instance, 45);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("corncube"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:corncube", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCornCubeBlockIsPlacedBy.executeProcedure($_dependencies);
			}
		}
	}
}
