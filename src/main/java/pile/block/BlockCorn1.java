...
import pile.procedure.ProcedureCorn1UpdateTick;
...
public class BlockCorn1 extends ElementsThePile.ModElement {
	@GameRegistry.ObjectHolder("pile:corn1")
	public static final Block block = null;
	public BlockCorn1(ElementsThePile instance) {
		super(instance, 173);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("pile:corn1", "inventory"));
	}
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(2F);
			setLightLevel(0F);
			setUnlocalizedName("corn1");
			setRegistryName("corn1");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCorn1UpdateTick.executeProcedure($_dependencies);
			}
