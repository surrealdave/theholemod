...
public class StructureGarlicTemple extends ElementsThePile.ModElement {
	public StructureGarlicTemple(ElementsThePile instance) {
		super(instance, 145);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 500) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("pile", "garlictemple"));
				if (template == null)
					return;
