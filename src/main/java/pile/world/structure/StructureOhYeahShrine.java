...
public class StructureOhYeahShrine extends ElementsThePile.ModElement {
	public StructureOhYeahShrine(ElementsThePile instance) {
		super(instance, 140);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 5) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("pile", "ohyeahshrine"));
				if (template == null)
					return;
