...
public class StructureFungusHouse extends ElementsThePile.ModElement {
	public StructureFungusHouse(ElementsThePile instance) {
		super(instance, 299);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 7000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("pile", "fungushouse"));
				if (template == null)
					return;
