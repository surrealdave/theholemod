...
public class StructureWormArchitecture extends ElementsThePile.ModElement {
	public StructureWormArchitecture(ElementsThePile instance) {
		super(instance, 417);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 1000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("pile", "wormtemple"));
				if (template == null)
					return;
