...
public class StructureMoyaiTemple extends ElementsThePile.ModElement {
	public StructureMoyaiTemple(ElementsThePile instance) {
		super(instance, 136);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 5000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("pile", "moyaitemple"));
				if (template == null)
					return;
