...
import pile.procedure.ProcedureDreamlandDimPlayerEntersDimension;

import pile.block.BlockPsystone;
...
public class WorldDreamlandDim extends ElementsThePile.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	public static DimensionType dtype;
	public WorldDreamlandDim(ElementsThePile instance) {
		super(instance, 339);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension dreamlanddim is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("dreamlanddim", "_dreamlanddim", DIMID, WorldProviderMod.class, true);
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureDreamlandDimPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}

	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockPsystone.block.getDefaultState();
		private static final IBlockState STONE2 = BlockPsystone.block.getDefaultState();
		private static final IBlockState FLUID = BlockPsystone.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("pile:dreamland")),
				Biome.REGISTRY.getObject(new ResourceLocation("pile:jelly")),
				Biome.REGISTRY.getObject(new ResourceLocation("pile:gorgonzolabiome")),};
