...
import pile.procedure.ProcedureDecrypt;
...
public class GuiDecrypterGUI extends ElementsThePile.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiDecrypterGUI(ElementsThePile instance) {
		super(instance, 317);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 8, 39) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 35, 39) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 35, 12) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 152, 21) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("pile:textures/decryptergui.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 61, this.guiTop + 20, 80, 20, "Discover"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureDecrypt.executeProcedure($_dependencies);
			}
		}
	}
