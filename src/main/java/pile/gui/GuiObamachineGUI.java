...
import pile.procedure.ProcedureObamachineMutate;
...
public class GuiObamachineGUI extends ElementsThePile.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiObamachineGUI(ElementsThePile instance) {
		super(instance, 277);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 134, 39) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("pile:textures/obamachinegui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Obamachine", 65, 11, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 61, this.guiTop + 38, 60, 20, "Mutate"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureObamachineMutate.executeProcedure($_dependencies);
			}
		}
	}
